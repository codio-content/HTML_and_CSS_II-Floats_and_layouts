This is a more classing layout. It could be used for a blog. It has a header at the top with full width, a sidebar on the left with some links, a main content part with some text, and finally a footer.
