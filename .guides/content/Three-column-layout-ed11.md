Now let's see a three column layout, we have three `div`s and all of them have `float:left;` and a width of 32%, because we wants spaces of 2% between elements.
